...
public class DecoratorRemovePatternTest {
	public static void main(String[] args) {
		...
		PizzaComponentDecorator pizzaHamComponent = new HamExtraPizzaComponentDecorator(mixPizza);
		mixPizza = pizzaHamComponent;
		if (pizzaHamComponent instanceof HamExtraPizzaComponentDecorator) {
			((HamExtraPizzaComponentDecorator)pizzaHamComponent).addExtra();
			System.out.println("Precio con extra de jamon: " + dformat.format(mixPizza.getPrice()));
			System.out.println("Producto con extra de jamon: " + mixPizza.getDescription());
		}
	}
}
