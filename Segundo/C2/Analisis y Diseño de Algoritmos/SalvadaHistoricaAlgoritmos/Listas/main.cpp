...
int main()
{
  ...
  do
    {
      cout << "Opciones: " << endl;
      cout << "N: Crear Nueva Lista" << endl;
      cout << "I: Insertar valor " << endl;
      cout << "E: Eliminar elemento " << endl;
      cout << "V: Ver el valor de un elemento" << endl;
      cout << "T: Ver la lista entera" << endl;
      cout << "S: Modificar un valor" << endl;
      cout << "L: Longitud de la lista " << endl;
      cout << "M: Capacidad Maxima" << endl;
      cout << "C: Concatena un lista" << endl;
      cout << "B: Busca un elemento " << endl;
      cout << "F: Finaliza el programa " << endl;
