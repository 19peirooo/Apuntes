...
int main()
{
  ...
  do
    {
	  cout << "N: Nuevo Arbol" << endl;
	  cout << "I:Imprimir Arbol" << endl;
	  cout << "C: Buscar elemento" << endl;
	  cout << "L: Lee el arbol" << endl;
	  cout << "B: Comprueba si es ABB" << endl;
	  cout << "V: Comprueba si es AVL" << endl;
	  cout << "A: Insertar un valor" << endl;
	  cout << "E: Eliminar un valor" << endl;
	  cout << "F: Liberar memoria" << endl;
	  cout << "S: Salir" << endl;
      cin >> opcion;
