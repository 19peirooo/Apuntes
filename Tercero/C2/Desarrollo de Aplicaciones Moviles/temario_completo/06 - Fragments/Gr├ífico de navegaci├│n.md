...
![navegacion.png](Gr%C3%A1fico%20de%20navegaci%C3%B3n/navegacion.png)
...
1. Dentro de cada uno de los fragments aplicar la lógica de navegación con la pulsación de cada uno de los botones.
...
1. Para poder capturar los parámetros en el Fragment destino basta con acceder a la clase Arg creada, mediante el siguiente código:
