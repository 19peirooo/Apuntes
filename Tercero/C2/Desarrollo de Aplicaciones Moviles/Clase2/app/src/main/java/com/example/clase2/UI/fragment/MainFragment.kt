...
import com.example.clase2.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onStart() {
        super.onStart()
        // binding.mainText.text = "Bienvenido ${currentUser.email}"
        database.reference
            .child("users")
            ...
            /*.addValueEventListener(object: ValueEventListener{
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.mainText.text = "Bienvenido ${usr!!.name.toString()}"
                }
